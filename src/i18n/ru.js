export default {
	...
	dialog: {
		...
		confirmCalibrationReset: {
			...
			prompt: 'Вы действительно хотите сбросить настройки калибровки шагов / мм до значений по умолчанию?'
		},
		confirmTouchProbe: {
			title: 'Выполнить последовательность сенсорных датчиков',
			prompt: 'Убедитесь, что концевая фреза находится над отверстием «Начало отсчета» с прикрепленным зажимом сенсорного датчика.',
			promptZ: 'Убедитесь, что концевая фреза находится в любом месте над самой тонкой частью сенсорного зонда с прикрепленным зажимом сенсорного зонда.',
			checkWorking: 'Прикоснитесь пластиной щупа к концевой фрезу, чтобы убедиться, что она работает правильно.'

		},
		confirmTouchProbeReset: {
			title: 'Восстановить настройки по умолчанию',
			prompt: 'Вы действительно хотите сбросить настройки щупа до значений по умолчанию?'
		},
		controlledPowerOffDialog: {
			message: 'Подождите, машина приостановлена',
		},
		confirmPowerOffDialog: {
			message: 'Теперь машину можно выключить.'
		},
		touchProbeSuccess: {
			title: 'Успех',
			prompt: 'Зонд завершен. Рабочий нулевой набор. Удалите зонд.'
		},
		connect: {
		...
		workingAreaReset: {
			title: 'Сбросить рабочую область',
			prompt: 'Выберите модель WorkBee, на которую вы хотите выполнить сброс.',
			workbeeModel: 'Модель WorkBee'
		},
	...
	notification: {
		calibration:{
			message: 'Калибровка шагов / мм обновлена',
		},
		compress: {
			title: 'Сжатие файлов...',
	...
	panel: {
		...
		settingsElectronics: {
			...
			sysVersion: 'Версия системных настроек: {0}',
