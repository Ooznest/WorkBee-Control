...
WorkBee Control, based on Duet Web Control, is a fully-responsive HTML5-based web interface for RepRapFirmware which utilizes the Bootstrap framework, JQuery and a few other libraries to allow easy control of Duet-based 3D printer electronics.
...
WorkBee Control is free software; it is licensed under the terms of the GNU Public License v3.
